    ...
    function [IsQuit, Performance] = test_abcdd_block(whichOrient)
    ...
    param_tmp(3,:) = [zeros(1,32) ones(1,32)];
            ...
            for theitem = 1:itemsPerBlock
                ...
                for theframe = 1:framesPerItem(theTrial)
                    ...
                    if whichOrient==1
                        ...
                        Screen('PutImage',offScrPtr(theTrial,gender, theitem, theframe),theimage, pixRect*1.1);
                    elseif whichOrient==2
                        Screen('PutImage',offScrPtr(theTrial,gender, theitem, theframe),flipdim(theimage,1), pixRect*1.1);
                    end
...
%     'endpoint7.1'
            ...
            for i = 1:imagesPerTrial(theTrial)
                ...
                for theframe = 1:framesPerItem(theTrial)
                    Screen('CopyWindow', offScrPtr(theTrial,whichGender(theTrial),thepic,theframe), window, [],...
